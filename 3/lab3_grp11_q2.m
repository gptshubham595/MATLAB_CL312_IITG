...
%the loop checks the convergence of the solutions, it stops when soln has
%coneverged wrt the criteria defined.
while errA > critN
 Nam = (Na1+Na2)/2;
...
iter, Na = Nam
%function mdif defines the system of differential eqns.
